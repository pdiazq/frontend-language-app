...
const Photo = (product) => {
  ...
  function countMouse1(){
    ...
    return (
        <>
          <h1> posición x : </h1>
            <div id="parentElement" className="img-zoom-container" onMouseOut={() => countMouse()} >
                <img id="myimage" className="carousel-item__img" src={product.cover} alt={product.title} onMouseOver={() => countMouse1()}/>
